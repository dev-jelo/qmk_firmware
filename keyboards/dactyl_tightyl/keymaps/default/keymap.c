...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------|                          |------+------+------+------+------+------|
     * | ALTAB| SHIFT| CTRL |  ALT | META |  VL- |                          | CLEFT| LEFT | DOWN | RIGHT| CRGHT|  DEL |
     * |------+------+------+------+------+------|                          |------+------+------+------+------+------|
     ...
     * |------+------+------+------+------+------|                          |------+------+------+------+------+------|
     * | NLCK | SHIFT|  F4  |  F5  |  F6  |  F11 |                          |   =  |   4  |   5  |   6  |   ,  |  DEL |
     * |------+------+------+------+------+------|                          |------+------+------+------+------+------|
    ...
    [NUM] = LAYOUT(
         ...
         KC_NUM,   MLSFT,   KC_F4,   KC_F5,   KC_F6,  KC_F11,                     KC_PEQL,   KC_P4,   KC_P5,   KC_P6, KC_COMM,  KC_DEL,
          KC_NO,   KC_NO,   KC_F1,   KC_F2,   KC_F3,  KC_F12,                     KC_PMNS,   KC_P1,   KC_P2,   KC_P3, KC_PSLS, KC_PENT,
